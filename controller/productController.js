  ...
  try {
    ...
    switch (true) {
      ...
      case image && image.size > 100000:
        return res
          .status(500)
          .send({ error: "image is require and should be less then 1mb" });
    }
...
export const deleteProductController = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .send({ success: false, message: "Error in deleting Product" });
  }
};
//update
...
// get image
export const productPhotoControoller = async (req, res) => {
  try {
